  ...
  $.fn.splitter = function(args){
    ...
    return this.each(function() {
      ...
      var opts = $.extend({
        ...
        animSpeed: 50 //animation speed in ms
      },{
        v:{ // Vertical
          moving:"left",sizing: "width", 
          eventPos: "pageX",
      ...
      A.after(C);
      C.attr({"class": opts.splitbarClass,unselectable:"on"})
        .css({"cursor":opts.cursor,"user-select": "none", "-webkit-user-select": "none","-khtml-user-select": "none", "-moz-user-select": "none"})
      ...
      function startDrag(e) {
        ...
        _ghost.addClass(opts.ghostClass).css('position','absolute')
          .css('z-index','250')
      ...
      function splitTo(perc,reversedorder,fast) {
        ...
        if(_ismovingNow||perc==undefined)
