...
$R.addAction( 'ui_wysiwyg', function( jNode ){
  ...
  if( 'simple' === settings.mode ){
    ...
    settings.theme_advanced_buttons3 = "tablecontrols,|,hr,removeformat,visualaid,|"
      +",charmap,emotions,iespell,image,wgt_mediatheke,|,insertdate,inserttime,|,advhr";
    ...
    $D.errorWindow( 'UI Error', 'Got undefined Editor mode '+settings.mode+', fallback to simple' );
  }
